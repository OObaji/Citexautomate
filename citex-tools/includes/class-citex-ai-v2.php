...
class Citex_AI_V2 {
	 ...
	 * at all — Gemini is never asked for one. `url` allows a realistic
	 * https:// address with an optional short path (not just a bare
	 * domain) — see build_prompt_website()'s own URL-length guidance.
	 */
	private static function schema_website() {
		$s   = array( 'type' => 'string' );
		$url = array( 'type' => 'string', 'maxLength' => 120 );
		return array( 'type' => 'object', 'properties' => array( 'questions' => array( 'type' => 'array', 'items' => array( 'type' => 'object', 'properties' => array(
