...
class Citex_AI_V2 {
	...
	private static function journal_article_design_prompt_note( $exercise_design ) {
		$notes = array(
			...
			'volume_issue'             => "EXERCISE DESIGN — VOLUME + ISSUE ONLY (exactly 2 draggable parts):\n- This particular question will only show and test the volume(issue) structure (\"14(2)\") in isolation — the smallest fragment this category tests, not the page range or any other part of the reference. Still provide the complete real record above.",
		);
