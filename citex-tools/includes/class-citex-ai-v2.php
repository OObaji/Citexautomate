...
class Citex_AI_V2 {
	 ...
	 * question (which 3-4 parts are drawn, Fixed Text, and every wrong
	 ...
	 * 3-4 parts are drawn, the wrong ("confusing") chip for each, Question
	...
	private static function normalise_website_item( $item, $id, $author, $year, $title, $publisher, $url, $scenario, $exercise, $difficulty, $expected_distractors, $exercise_design = 'author_year_title' ) {
		...
		// precisely because it cannot satisfy the hard 3-4-part DragDrop
		// rule; reject outright if it is ever assigned to a DragDrop slot.
