...
check( '[3] three authors: exactly 3 parts (joined authors, year, title)', $shape_three['parts'], array( 'Smith, J., Jones, P. and Brown, T.', '2020', 'Understanding digital culture' ) );
check( '[3] three authors: fixedText has 3 placeholder tokens', $shape_three['fixedText'], '| (||) ||. London: SAGE Publications.' );
