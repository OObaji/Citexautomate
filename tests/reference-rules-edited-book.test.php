...
// ---------------------------------------------------------------------
// 6. DragDrop shape: exactly 3 draggable parts (editors-joined,
// designation, year — the default/baseline design), title/place/publisher
// fixed — matching the plugin's every-DragDrop-question-has-exactly-3-parts
// rule, place/publisher never draggable for any category.
// ---------------------------------------------------------------------
$shape_one = Citex_Reference_Rules::dragdrop_shape( Citex_Reference_Rules::CATEGORY_EDITED_BOOK, $one_editor );
check( '[6] one-editor DragDrop shape has exactly 3 parts', count( $shape_one['parts'] ), 3 );
check( '[6] one-editor DragDrop parts are [editorsJoined, designation, year]', $shape_one['parts'], array( 'Smith, J.', 'ed.', '2022' ) );
check( '[6] one-editor fixedText bakes in title/place/publisher, matches the reconstruction rules', $shape_one['fixedText'], '| (||) (||) Digital media and society. London: SAGE Publications.' );
...
check( '[6] two-editor DragDrop fixedText folds the second editor in as a correct literal continuation', $shape_two['fixedText'], '| and Jones, A. (||) (||) Digital media and society. London: SAGE Publications.' );
