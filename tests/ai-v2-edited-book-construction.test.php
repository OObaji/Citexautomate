...
if ( ! is_wp_error( $mcq_result ) ) {
	...
	check( '[2] the question text is Citex\'s own fixed Edited Book MCQ stem', $mcq_candidate['scenario'], 'Which of the following is the correct reference for an edited book?' );
