...
function treatment_question( $overrides = array() ) {
	return array_merge(
		array(
			...
			'scenario'        => 'Which statement is correct about a book with four or more authors in the reference list?',
			'options'         => array(
...
function edited_treatment_question( $overrides = array() ) {
	return array_merge(
		array(
			...
			'scenario'        => 'Which of the following statements is correct about referencing a book edited by two people in the reference list?',
			'options'         => array(
			...
			'reconstructedReference' => 'Both editors are included, joined by "and", followed by the designation "(eds)".',
		),
		$overrides
	);
}
...
$eb_three_or_more = Citex_Generated_Validator::validate( edited_treatment_question( array(
	...
	'scenario'         => 'Which of the following statements is correct about referencing a book edited by three or more people in the reference list?',
	'reconstructedReference' => 'All editors are included, separated by commas with "and" before the final editor, followed by the designation "(eds)".',
) ) );
